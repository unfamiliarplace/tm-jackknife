 ...
 * Purpose: Shorter image; our image getter; our meta info
 */
class td_module_41 extends td_module_4 {
        ...
        <div class="<?php echo $this->get_module_classes();?>">
            <div class="td-module-image">
	            <?php
                    ...
                    if (td_util::get_option('tds_category_module_41') == 'yes') { echo $this->get_category(); }
	            ?>
            </div>
